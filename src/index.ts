          ...
          130316: [
            {
              node: function(n2k: any) {
                ...
                let map: any = getMap(options.temperatureMapping, '' + n2k.fields['Source'], n2k.fields['Instance']);
 ...
 * @returns 
 */
function getMap(mapping: TemperatureMap[], source: string, instance: any): TemperatureMap | undefined {
  let retval:TemperatureMap | undefined = undefined;
